...
class ModelViewParameters(MyTableModel):
    ...
    def InsertModelAnalyse(self,idModelAnalyse):
...
#        self.mapper.setItemDelegate(TypeAnalyseDeleguate(parent))
    ...
    def IsQuantitatif(self, isQuantitatif):
        self.isImage=not isQuantitatif
        return self.isImage
...
#            self.Resultats = ResultatAnalyseParametre(idAnalyse)#parent.tableview_parametre.model()
...
#     
#     def GetParametresModele(self):
#         return [i[1] for i in self.listdata]
#             
